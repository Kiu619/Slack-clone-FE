  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button
          className="flex items-center gap-x-2 hover:bg-[#312235] px-2 hover:cursor-pointer rounded-md"
        >
      ...
      >
        <div className="py-3">
          ...
          <Separator className="my-2" />
          <div className="px-6 hover:bg-selection-hover cursor-pointer">Preferences</div>
          <Separator className="my-2" />
