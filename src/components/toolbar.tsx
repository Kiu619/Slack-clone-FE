...
const Toolbar = ({ currentWorkspaceData }: ToolbarProps) => {
  return (
    <div className="h-[42px] bg-workspace-background flex items-center justify-center">
      <div className="flex items-center gap-x-2">
        ...
        <button className="max-w-[1000px] lg:w-[950px] w-[500px] bg-[#735078] rounded-md hover:cursor-pointer border flex items-center h-[28px]">
