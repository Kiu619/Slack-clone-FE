...
interface EditorProps {
  ...
  disabled?: boolean
  /** Callback khi user attach files (trả về messageId để upload) */
...
const Editor = ({
  ...
  /**
   * typingTimeoutRef: dùng để debounce typing:stop event
   * Khi user ngừng gõ 2 giây → emit typing:stop
   */
  ...
  /**
   * handleTyping — debounced typing indicator
   *
   * Khi user gõ: emit typing:start (chỉ 1 lần, không spam)
   * Sau 2s không gõ: emit typing:stop
   */
  ...
  }, [editor, disabled, onSubmit, onTypingStop])
