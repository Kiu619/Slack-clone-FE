        ...
        <CustomDialogBody className="bg-white dark:bg-[#1A1D21] p-6">
          <FieldGroup className="space-y-4">
            <Field>
              ...
              <Input id="name-1" name="name" className="bg-transparent border-[#565856] focus:border-selection-hover transition-all" />
            </Field>
            <Field>
              <Label htmlFor="username-1" className="">Link</Label>
              <Input id="username-1" name="username" className="bg-transparent border-[#565856] focus:border-selection-hover transition-all" />
            </Field>
          </FieldGroup>
        </CustomDialogBody>

        <CustomDialogFooter className="px-6 py-4">
          <Button variant="ghost" onClick={() => setOpen(false)} className="dark:hover:bg-[#2C2E33] mr-2">Cancel</Button>
